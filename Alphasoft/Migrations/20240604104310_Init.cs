        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutMainSologan = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OurMissionDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OurVisionDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhyUsDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhoWeAreDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhoWeAreImageOne = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhoWeAreImageTwo = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolganOne = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SolganTwo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SolganThree = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OportunityDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OurBenifiteDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OurCultureDescription = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientSaysAboutUs = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CPanel = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DropdownType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OurTeams_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OurTeams_Designations_DesignationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WholeSellPrice = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OurTeams_DepartmentId",
                table: "OurTeams",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_OurTeams_DesignationId",
                table: "OurTeams",
